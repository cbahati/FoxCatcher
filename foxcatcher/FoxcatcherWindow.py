...
dev_key  = 0 # global variable for your developer's key
...
class FoxcatcherWindow(Window):
    ...
    def delete_artist_list(self, widget):
        ...
        artist_list = file_setting.parse_file_list("data/settings/name_setting.txt")
    ...
    def delete_button_clicked(self, widget, store):
        ...
        for path in paths:
            ...
            file_setting.delete_data(val, "data/settings/name_setting.txt")
            model.remove(iter)
    ...
    def search_button_clicked(self, widget, store):
        ...
        city_list = file_setting.parse_file("data/settings/cities.txt")
    ...
    def add_location_button_clicked(self, widget, store):
        ...
        for path in paths:
            iter = model.get_iter(path)
            val = store.get_value(iter,1)
            file_setting.write_data(val, "data/settings/city_setting.txt")
            self.entry.set_text("")
            model.remove(iter)
    ...
    def view_location_button_clicked(self, widget, store):
        store.clear()
        location = file_setting.parse_file_list("data/settings/city_setting.txt")
    ...
    def add_button_clicked(self, widget):
        ...
        if temp > 0:
            ...
            infile = open("data/settings/name_setting.txt", "ab")
